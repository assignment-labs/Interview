...
// Function to initialize the Google GenAI with your API key
...
exports.generateInterviewQuestions = async (interviewData) => {
  try {
    ...
    const ai = await initializeGoogleGenAI();
...
function generateFallbackQuestions(interviewData) {
  ...
  const questions = [
    ...
    },
    {
      id: "q2",
      question:
        "Where do you see yourself professionally in the next 3-5 years, and how does this role align with your career goals?",
      type: "goals",
  ...
  const roleQuestions = getRoleSpecificQuestions(
    role,
    experienceLevel,
    difficulty
  );
...
function getRoleSpecificQuestions(role, experienceLevel, difficulty) {
  ...
  // Backend Developer Questions
    ...
    normalizedRole.includes("server")
  ) {
    return [
      {
        id: "q3",
      ...
      },
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would explain normalization forms, redundancy reduction, and performance trade-offs for basic questions. For queuing, message brokers, event-driven architecture, and decoupling services would be discussed. Advanced microservice answers would cover saga patterns, distributed transactions, event sourcing, and CQRS.",
      },
    ];
  }
    ...
    return [
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would cover technology selection, architecture decisions, data flow, and implementation strategy with examples from past projects. It would demonstrate end-to-end understanding from database design to UI/UX.",
      },
      {
        id: "q4",
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would discuss API design, error handling, state management, and security considerations. For authentication, it would cover JWT, sessions, OAuth flows, and protection against common attacks. Advanced answers would address API gateways, BFFs, and cross-cutting concerns.",
      },
      {
        id: "q5",
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would mention logging, monitoring tools, browser dev tools, and systematic troubleshooting approaches. For data modeling, relationship design, ORM usage, and normalization considerations would be discussed. DevOps answers would cover CI/CD, containerization, infrastructure as code, and automated testing.",
      },
    ];
  }
    ...
    return [
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would explain continuous integration and delivery practices, automation benefits, and quality improvements. For containerization, Docker, Kubernetes, service discovery, and scaling strategies would be discussed. Advanced pipeline answers would address environment parity, security gates, and zero-downtime deployments.",
      },
      {
        id: "q4",
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would mention specific monitoring tools, key metrics, and alert threshold strategies. For IaC, tools like Terraform, CloudFormation, or Ansible would be discussed along with version control and testing approaches. Advanced observability answers would cover the three pillars: metrics, logs, and traces.",
      },
      {
        id: "q5",
        question:
  ...
  // Data Scientist Questions
    ...
    normalizedRole.includes("data sci") ||
  ...
  // Product Manager Questions
    ...
    return [
      ...
      },
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would mention user research methods, feedback channels, and iterative improvement processes. For technical collaboration, requirement documentation, user stories, acceptance criteria, and technical constraints would be discussed. Market entry answers would cover competitive analysis, differentiation strategy, and go-to-market planning.",
      },
      {
        id: "q5",
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would discuss both business metrics (revenue, retention) and product metrics (engagement, conversion) with examples. For decision-making, approaches to risk assessment, validation, and course correction would be covered. Team building answers would address hiring strategies, innovation processes, and fostering a product culture.",
      },
    ];
  }
    ...
    return [
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would discuss test coverage, risk-based testing, and requirements traceability. For test types, unit, integration, system, and acceptance testing would be explained with appropriate use cases. Automation strategy answers would cover tool selection, framework design, and maintenance approaches.",
      },
      {
        id: "q4",
        question:
  ...
  // Mobile Developer Questions
    ...
    normalizedRole.includes("mobile") ||
    normalizedRole.includes("ios") ||
    normalizedRole.includes("android")
  ) {
    return [
      {
        id: "q3",
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would discuss app states, lifecycle methods, and state persistence approaches. For performance, memory management, rendering optimization, and network handling would be covered. Architecture answers would address local storage, conflict resolution, and synchronization patterns.",
      },
      {
        id: "q4",
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would cover layout systems, responsive design patterns, and UI component reuse. For platform differences, abstraction layers, feature detection, and graceful degradation would be discussed. Security answers would address encryption, secure storage, certificate pinning, and authentication.",
      },
      {
        id: "q5",
        question:
  ...
  // Software Engineer (General) Questions
    ...
    return [
      ...
      },
      {
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would mention methodical troubleshooting, logging, monitoring tools, and root cause analysis. For design patterns, specific patterns, appropriate use cases, and implementation trade-offs would be discussed. Data processing answers would cover stream processing, partitioning strategies, and throughput optimization.",
      },
      {
        id: "q5",
        question:
  ...
  primaryTechs.forEach((tech, index) => {
    ...
    // Node.js
      ...
      questions.push({
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would explain the non-blocking I/O model, event loop phases, and callback patterns. For error handling, async/await patterns, try/catch blocks, and centralized error handling would be discussed. Scalability answers would address clustering, load balancing, and stream processing techniques.",
      });
    }
    ...
    // Machine Learning
      ...
      questions.push({
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would define each learning type with appropriate use cases and evaluation metrics. For overfitting prevention, regularization techniques, cross-validation, and appropriate data splitting would be covered. MLOps answers would address automated pipelines, feature stores, model monitoring, and deployment strategies.",
      });
    }

    // AWS/Cloud
    else if (
      normalizedTech.includes("aws") ||
      normalizedTech.includes("azure") ||
      normalizedTech.includes("cloud")
    ) {
      questions.push({
        id: `q${index + 6}`,
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would mention specific services used (compute, storage, networking) and implementation details. For architecture, auto-scaling strategies, serverless approaches, and resource optimization would be discussed. High availability answers would cover region replication, failover mechanisms, and recovery point/time objectives.",
      });
    }

    // SQL/Databases
    else if (
      normalizedTech.includes("sql") ||
      normalizedTech.includes("database") ||
      normalizedTech.includes("postgres")
    ) {
      questions.push({
        id: `q${index + 6}`,
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would cover normalization principles, indexing strategies, and relationship modeling. For performance, query optimization, execution plans, and caching would be discussed. Sharding answers would address partition keys, data distribution strategies, and handling cross-shard operations.",
      });
    }

    // NoSQL
    else if (
      normalizedTech.includes("mongo") ||
      normalizedTech.includes("nosql") ||
      normalizedTech.includes("dynamodb")
    ) {
      questions.push({
        id: `q${index + 6}`,
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would discuss ACID properties, schema flexibility, and scaling characteristics. For data modeling, denormalization strategies, embedding vs. referencing, and query optimization would be covered. Hybrid system answers would address data consistency, synchronization patterns, and appropriate use cases for each database type.",
      });
    }

    // Docker/Kubernetes
    else if (
      normalizedTech.includes("docker") ||
      normalizedTech.includes("kubernetes") ||
      normalizedTech.includes("container")
    ) {
      questions.push({
        id: `q${index + 6}`,
        question:
        ...
        type: "technical",
        sampleAnswer:
          "A good answer would cover container isolation, portability, and consistent environments. For Kubernetes, deployment strategies, service discovery, and resource management would be discussed. Platform design answers would address namespaces, RBAC, network policies, and multi-tenancy considerations.",
      });
    }
...
function getProblemSolvingQuestion(role, difficulty, experienceLevel) {
  ...
  if (normalizedRole.includes("frontend") || normalizedRole.includes("ui")) {
    return {
      ...
      sampleAnswer:
        "A good answer would demonstrate a methodical approach to problem-solving, including isolation techniques, browser dev tools, and cross-browser testing for simple issues. For refactoring, incremental approaches, test coverage, and documentation strategies would be discussed. Complex offline solutions would address local storage, conflict resolution, and progressive enhancement.",
    };
  }
  ...
  // Backend specific problem-solving
    ...
    return {
      ...
      type: "problem-solving",
      sampleAnswer:
        "A good answer would mention profiling tools, database query optimization, and caching strategies for performance issues. For microservices, domain-driven design, service boundaries, and migration approaches would be discussed. High-throughput systems would address messaging patterns, backpressure handling, and exactly-once processing guarantees.",
    };
  }
  ...
  // Data Science specific problem-solving
    ...
    return {
      ...
      type: "problem-solving",
      sampleAnswer:
        "A good answer would discuss sampling techniques, class weighting, and appropriate evaluation metrics for imbalanced data. For limited data scenarios, transfer learning, data augmentation, and semi-supervised approaches would be covered. Real-time systems would address model serving architectures, feature stores, and online learning approaches.",
    };
  }
  ...
  // Generic problem-solving question based on difficulty
    ...
    return {
      ...
      type: "problem-solving",
      sampleAnswer:
        "A good answer would demonstrate a methodical approach to problem-solving with attention to detail, systematic troubleshooting, and root cause analysis. For complex system design, trade-off analysis, architectural patterns, and iterative implementation approaches would be covered.",
    };
  }
}
  ...
  if (roleSpecificElement && !question.includes(roleSpecificElement)) {
    if (question.includes("Tell me about a time when")) {
      question = question.replace(
        ...
        `Tell me about a time when, ${roleSpecificElement},`
      );
    } else if (question.includes("Describe a situation where")) {
      question = question.replace(
        "Describe a situation where",
        `Describe a situation where, ${roleSpecificElement},`
      );
    }
  }
